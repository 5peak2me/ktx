 ...
 */
package com.github.speak2me.ktx.internal

/**
 * Marks declarations that are **internal** in ktx API, which means that should not be used outside of
 * `com.github.speak2me`, because their signatures and semantics will change between future releases without any
...
@RequiresOptIn(
  ...
  message = "This is an internal ktx API that " +
    "should not be used from outside of com.github.speak2me.ktx. No compatibility guarantees are provided. " +
