...
): MavenArtifactRepository = maven { repository ->
  repository.setUrl("https://mirrors.cloud.tencent.com/nexus/repository/maven-public")
  repository.mavenContent(descriptor)
}
...
public fun RepositoryHandler.aliyun(
  ...
  repository.setUrl("https://maven.aliyun.com/repository/$repo")
  repository.mavenContent(descriptor)
}
...
public fun RepositoryHandler.huawei(
  ...
  repository.setUrl("https://repo.huaweicloud.com/repository/maven")
  repository.mavenContent(descriptor)
}
